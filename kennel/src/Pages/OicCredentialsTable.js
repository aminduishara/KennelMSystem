...
const OicCredentialsTable = () => {
  ...
  const rankOptions = ['SI', 'IP', 'SSP']; // Add your rank options here

  return (
    
    <div style={{ backgroundColor: '#ADD8E6', minHeight: '100vh' }} >
      <h3 className="text-center fw-bold">OIC Credentials Table</h3>
      <br />
          ...
          {credentials.map((credential) => (
            <tr key={credential.id}>
              ...
              <td>
                ...
                <Button
                  variant="danger"
                  className="custom-delete-btn-oicCredentialTable"
